        ...
        <Toolbar>
          <ToolbarContent>
            ...
            <ToolbarItem>
              ...
              >
                <DropdownList>
                  <DropdownItem onClick={() => showToast('Export preparing for download', <><div>downloading export subscriptions_inventory.csv</div><Button variant="link" isInline style={{ marginTop: '8px' }} onClick={() => openSchedulerWizard({ preselectedService: 'Subscription Services', preselectedTask: 'Subscription Inventory', preselectedFileType: 'CSV' })}>Make this a recurring report</Button></>)}>Export to CSV</DropdownItem>
                  <DropdownItem onClick={() => showToast('Export preparing for download', <><div>downloading export subscriptions_inventory.json</div><Button variant="link" isInline style={{ marginTop: '8px' }} onClick={() => openSchedulerWizard({ preselectedService: 'Subscription Services', preselectedTask: 'Subscription Inventory', preselectedFileType: 'JSON' })}>Make this a recurring report</Button></>)}>Export to JSON</DropdownItem>
